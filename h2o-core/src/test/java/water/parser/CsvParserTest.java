...
public class CsvParserTest {
  ...
  public void fileHasHeader() {
    final int header_status = csvParser.fileHasHeader(WITH_HEADER.getBytes(), parseSetup);
    assertEquals(ParseSetup.HAS_HEADER, header_status);
  }
  ...
  public void emptyFile() {
    ...
    csvParser.fileHasHeader(EMPTY.getBytes(), parseSetup);
  }
